...
const Footer = () => {
  ...
  return (
    <footer className="bg-white">
      <div className="container flex flex-col  p-4 mx-auto md:p-8  dark:divide-gray-600">
        ...
        <ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
         ...
         <div className="border-[1px] border-gray-300 shadow w-2/3 mx-auto mb-6"></div>
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              ...
              href="#"
              title="Instagram"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-default-600 dark:text-gray-50"
            >
              <svg
